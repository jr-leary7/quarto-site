...
cell_offset <- createCellOffset(seu, scale.factor = 1e4)
scLANE_res <- testDynamic(raw_counts, 
                          pt = sling_pt, 
...
p11 <- ggplot(gene_clust_df, aes(x = umap1, y = umap2, color = leiden)) + 
       ...
       labs(x = "UMAP 1", 
            ...
            subtitle = "Top 2,000 significantly dynamic genes after PCA") +
